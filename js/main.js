/************* Main Js File ************************
Template Name: Eqin - Creative Personal Template
    Author: Mustafa729
    Version: 1.0
    Copyright 2018
*************************************************************/
...
$(function () {
    ...
    mainBannerArea.owlCarousel({
        ...
        nav: true,
        mouseDrag: true,
        navText: ['<i class="ti-arrow-left" aria-hidden="true"></i><div class="itemprebg"></div>', '<div class="itemnextbg"></div><i class="ti-arrow-right" aria-hidden="true"></i>'],
        autoplay: true,
        touchDrag: true,
        lazyLoad: true,
    ...
    mainBannerArea.on('translate.owl.carousel', function () {
        $('.single-banner h1 span, .single-banner h1, .single-banner a').removeClass('slideInLeft animated').hide();
    });

    mainBannerArea.on('translated.owl.carousel', function () {
        slideThumb();
        $('.owl-item.active .single-banner h1 span, .owl-item.active .single-banner h1, .owl-item.active .single-banner a').addClass('slideInLeft animated').show();
    });
    ...
    $(window).on('scroll', function () {
        ...
        $('section').each(function () {
            ...
            if ($(window).scrollTop() > $(this).offset().top) {
                ...
                $('.navbar-nav li a[data-link="' + blockID + '"]').addClass('active');
    ...
    if (top > batas) {
        ...
        $('header nav').addClass('nav-sticy');
        $('header').addClass('t-shadow');

    } else {

        $('header nav').removeClass('nav-sticy');
